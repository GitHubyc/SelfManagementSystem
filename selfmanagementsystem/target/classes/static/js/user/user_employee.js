...
$('.s_search').click(function() {
   ...
   function InitMainTable() {
	   var table = $('#tb_departments').bootstrapTable({
            ...
            columns: [{checkbox: true},{  field: 'name',
            	title: '姓名',
            	 align   : 'center'
        	},{
                field: 'employeeCode',
	   ...
	   $('#tb_departments').click(function(){  
		   ...
		   if(typeof(data) == 'undefined') {  
			alert('请选择一列数据!'); 
			   ...
			   parent.$('[name="employeeCodeShow"]').attr("value", data.name);
			   parent.$('[name="employeeCode"]').attr("value", data.employeeCode);
