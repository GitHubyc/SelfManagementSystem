$(document).ready(function(){
	$("#Employee_edit select[name='documentType']").change(function(){	
		var num=$(this).val();
		var $templateEle = $("#Employee_edit .form_content"),
	...
	$('#Employee_edit').bootstrapValidator('addField', $el);
	});
    //添加验证
    $('#Employee_edit')
    .bootstrapValidator({
        ...
        if( bv.isValid()){
            var data = {};
            var t = $('#Employee_edit').serializeArray();
            $.each(t, function() {
