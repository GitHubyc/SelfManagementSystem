	   ...
	   var table = $('#tb_departments').bootstrapTable({
            ...
            queryParams:function (params) {
                var temp = {   // 这里的键的名字和控制器的变量名必须一直，这边改动，控制器也需要改成一样的
                        ...
                        plcBuildCode: $("[name='search']").val(),
                        buildCode: $("[name='search']").val()
                    };
            ...
            columns: [{checkbox: true},{  field: 'buildName',
            	title: '建筑名称',
            	 align   : 'center'
        	},{
                field: 'plcBuildCode',
	   ...
	   $('#tb_departments').click(function(){  
		   ...
		   if(typeof(data) == 'undefined') {  
			alert('请选择一列数据!'); 
			   ...
			   parent.$('[name="plcBuildCodeShow"]').attr("value", data.buildName);
			   parent.$('[name="plcBuildCode"]').attr("value", data.plcBuildCode);
